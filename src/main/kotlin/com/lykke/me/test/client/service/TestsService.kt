...
interface TestsService {
    fun startAllTests(runTestsPolicy: RunTestsPolicy = RunTestsPolicy.CONTINUE_ON_ERROR): String?

    fun startTests(testNames: Set<String>, runTestsPolicy: RunTestsPolicy = RunTestsPolicy.CONTINUE_ON_ERROR): String?
